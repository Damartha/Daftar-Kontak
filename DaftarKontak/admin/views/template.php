    ...
    <div class="container">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Daftar Kontak</a>
                </div>
        ...
        <div class="row content">
            <div class="col-md-3 col-xs-12">
                <ul class="list-group">
                    <li class="list-group-item"><a href="index.php?mod=daftar"><i class="fa fa-address-card"></i> <span class="hidden-xs">Kontak</span></a></li>
                </ul>
            </div>
